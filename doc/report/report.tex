...
It can also be used as a classic chart generator by importing raw files.
...
First, we decided to implement an extension module of YCSB to include a pseudo real-time output of the results. The major challenge was not to slow down the processing speed of YCSB neither influence the benchmark results. 
