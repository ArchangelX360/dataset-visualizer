...
\todo{Valeur ajouté sur le fait qu'on peut enlever facilement la warmup phase de YCSB en resizant, et mettre en garde les utilisateurs de YCSB classique sur ce point}
