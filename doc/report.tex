...
We implemented candlestick --- boxplot without a median --- charts support to prove our point and providing a solid example for the documentation. See Figure \ref{candlestick} to see the result!
...
\begin{figure}[ht]
\begin{center}
\includegraphics[scale=0.6]{images/candlestick.png}
