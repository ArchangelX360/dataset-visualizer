        ...
        self.handler('focus', {
            ...
            onEnd: function (ev, pointer) {
                ...
                function canFocus(element) {
                    ...
                    return (element.getAttribute('tabindex') != '-1') && !element.hasAttribute('DISABLED') &&
